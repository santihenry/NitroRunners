...
Shader "preview"
{
	Properties
	{
		...
		[HDR]_distance("distance", Color) = (0.1180909,0.7169812,0,0)
	...
	SubShader
	{
		...
		{
			float4 lerpResult90 = lerp( _Color1 , _distance , _distFloor);
			...
			o.Alpha = ( lerpResult82 * _distFloor ).r;
		}
...
/*ASEBEGIN
Version=17800
3;433;930;276;-3110.367;29.75598;1.100276;True;False
...
Node;AmplifyShaderEditor.ColorNode;86;3334.569,-633.1696;Inherit;False;Property;_Color1;Color 1;5;0;Create;True;0;0;False;0;1,0,0,0;1,0.3026947,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;85;3324.895,-817.1348;Inherit;False;Property;_distance;distance;4;1;[HDR];Create;True;0;0;False;0;0.1180909,0.7169812,0,0;9.734288,0.05096486,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;82;3365.199,-305.8077;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;102;3878.234,22.43387;Inherit;False;Global;_distFloor;_distFloor;6;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=65ABBA5F92A43850AE8314FF51A8FE675A671154