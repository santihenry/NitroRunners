...
Shader "preview"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = ( lerpResult82 * (1.0 + (clampResult96 - 0.0) * (0.7 - 1.0) / (20.0 - 0.0)) ).r;
		}
...
/*ASEBEGIN
Version=17800
65;388;930;276;-846.0316;779.7808;1;True;False
...
ASEEND*/
//CHKSM=9547D068AD815367AC7073565DFD8EACEDC18F6C